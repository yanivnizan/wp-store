 ...
 *  A <code>OnGoodBalanceChangedEvent</code> is fired.
 */
namespace SoomlaWpStore.events
{

    public class GoodBalanceChangedEventArgs : EventArgs
    {
         ...
         * @param amountAdded
         */
        public GoodBalanceChangedEventArgs(VirtualGood good, int balance, int amountAdded)
        {
            mGood = good;
            mBalance = balance;
